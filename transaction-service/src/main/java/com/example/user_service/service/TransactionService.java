...
import com.example.user_service.mapper.TransactionMapper;
...
public class TransactionService {
    ...
    @Transactional
    public TransactionResponseDTO createTransaction(com.example.user_service.dto.requestDto.TransactionRequestDTO requestDTO) {
        ...
        kafkaProducer.publishUserCreatedEvent(transaction);
    ...
    public Page<TransactionResponseDTO> getTransactionsByUserId(String userId, int page, int size) {
